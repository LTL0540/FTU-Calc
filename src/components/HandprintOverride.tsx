  ...
  return (
    <details className="card settings-card handprint-card">
      ...
      <div className="handprint-settings">
        <p>Independent override: enter either value to replace—not combine with—the painted-area total. Uses 1 adult handprint = 0.8% BSA = 0.25 g. Independently rounded regional FTU tables will not reconcile exactly with 100% BSA.</p>
